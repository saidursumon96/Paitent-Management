...
public class RecyclerAdapterDoctorList extends RecyclerView.Adapter<RecyclerAdapterDoctorList.ViewHolder>{

    Context context;
    List<DataAdapterAll> dataAdapterAlls;

    public RecyclerAdapterDoctorList(List<DataAdapterAll> getDataAdapterAll, Context context){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_view_doctors, parent, false);
